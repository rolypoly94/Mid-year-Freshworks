...
const App = () => {
  ...
  const downloadTemplate = async () => {
    ...
    const instructionsData = [
      ...
      { 'Instruction': 'Start of Year Goals', 'Details': 'Goals are imported via the dedicated "Import Goals" button on the Admin page using the goals export sheet from Workday — not from this employee sheet.' },
